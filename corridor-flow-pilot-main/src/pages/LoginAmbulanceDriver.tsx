...
export default function LoginAmbulanceDriver() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 simple-grid-bg">
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-1/3 w-64 h-64 bg-ambulance/10 rounded-full blur-3xl float" style={{ animationDelay: '4s' }}></div>
      </div>
      <LoginForm 
